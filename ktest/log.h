...
void log_f_modeline_cb(const char* text, unsigned pixel_clock, unsigned hde, unsigned hbs, unsigned hrs, unsigned hre, unsigned hbe, unsigned ht, unsigned vde, unsigned vbs, unsigned vrs, unsigned vre, unsigned vbe, unsigned vt, _Bool hsync_pol, _Bool vsync_pol, _Bool doublescan, _Bool interlace);
void log_f_modeline_c(const char* text, unsigned pixel_clock, unsigned hde, unsigned hrs, unsigned hre, unsigned ht, unsigned vde, unsigned vrs, unsigned vre, unsigned vt, _Bool hsync_pol, _Bool vsync_pol, _Bool doublescan, _Bool interlace);

/** \addtogroup Log */
/*@{*/

int log_init(const char* file, _Bool sync_flag);
void log_done(void);
void log_abort(void);
